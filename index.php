...
<p>If you are having problems with your database, <a href="delete_db.php" onclick="if(!confirm('Are you sure you want to delete your database?')) return false;">Delete database</a></p>
<div id="box">
	<div class="command">
